...
expName = 'ODT'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\kanis\\Desktop\\Monsoon2022\\Lab in Psychology\\OrientationDiscriminationTask\\ODT_lastrun.py',
...
Fixation = visual.ShapeStim(
    win=win, name='Fixation', vertices='star7',units='pix', 
    size=(10, 10),
